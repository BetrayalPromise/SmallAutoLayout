...
- (void)viewDidLoad {
    ...
    [v0.CenterX equalTo:self.view.CenterX multiplier:0.5];
    ...
    [v1.CenterX equalTo:self.view.CenterX multiplier:1.5];
    ...
    [v2.CenterX equalTo:self.view.CenterX multiplier:0.5];
    ...
    [v3.CenterX equalTo:self.view.CenterX multiplier:1.5];
